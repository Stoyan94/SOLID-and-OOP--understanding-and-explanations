...
| Модификатор   | Достъпност | Клас   | Наследници | Същия проект | Други проекти |
| ------------- | ---------- | ----   |----------  | ------------ | ------------- |
| ** private**   | Приватен   | ✅ да | ❌ не     | ❌ не        | ❌ не          |

| ** protected** | Защитен    | ✅ да | ✅ да     | ❌ не        | ❌ не          |

| ** internal**  | Вътрешен   | ✅ да | ✅ да     | ✅ да        | ❌ не          |

| ** public**    | Публичен   | ✅ да | ✅ да     | ✅ да        | ✅ да          |
